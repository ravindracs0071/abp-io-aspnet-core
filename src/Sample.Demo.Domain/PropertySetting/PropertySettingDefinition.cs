...
namespace Sample.Demo.PropertySetting
{
    public class PropertySettingDefinition
    {
        ...
        /// </summary>
        public virtual PropertySettingDefinition WithProperty(string key, object value)
        {
        ...
        /// This is a shortcut for nested calls on this object.
        /// </summary>
        public virtual PropertySettingDefinition WithProviders(params string[] providers)
        {
